...
#define DEBUG_PRINT(str) \
    ...
    g_system_table->ConOut->OutputString(g_system_table->ConOut,L"[KURO|DEBUG] " str)
#endif

#define PRINT(str) \
    g_system_table->ConOut->SetAttribute(g_system_table->ConOut, EFI_LIGHTGRAY); \
    g_system_table->ConOut->OutputString(g_system_table->ConOut,L"[KURO|INFO] " str)

#define WARN_PRINT(str) \
    g_system_table->ConOut->SetAttribute(g_system_table->ConOut, EFI_YELLOW); \
    g_system_table->ConOut->OutputString(g_system_table->ConOut,L"[KURO|WARN] " str)

#define ERROR_PRINT(str) \
    g_system_table->ConOut->SetAttribute(g_system_table->ConOut, EFI_RED); \
    g_system_table->ConOut->OutputString(g_system_table->ConOut,L"[KURO|ERROR] " str)
