...
EFI_LOADED_IMAGE_PROTOCOL* get_loaded_image_protocol(EFI_HANDLE image_handle) {
  ...
  g_system_table->BootServices->OpenProtocol(
      image_handle, &g_lip_guid, (void**)&loaded_image, g_image_handle, NULL,
...
EFI_FILE_PROTOCOL* get_volume_handle(
  ...
  g_system_table->BootServices->OpenProtocol(
      ...
      g_image_handle, NULL, EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL);
