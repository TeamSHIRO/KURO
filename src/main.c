...
EFI_STATUS efi_main(EFI_HANDLE image_handle_p, EFI_SYSTEM_TABLE *system_table_p)
{
    ...
    g_system_table->ConOut->OutputString(g_system_table->ConOut, L"Hello, World!\r\n");
    ...
    void *input_buffer;
    g_system_table->BootServices->AllocatePool(EfiLoaderData, file_size, &input_buffer);
    ...
    CHAR16 *out;
    g_system_table->BootServices->AllocatePool(EfiLoaderData, (char_count + 3) * sizeof(CHAR16), (void **)&out);
